...
import com.pages.TipsAndGrowthPage;
...
public class tipsandGrowth extends BaseSteps {

    TipsAndGrowthPage tipsAndGrowthPage;
    ExtentTest extTest = Hooks.extTest;

    @Given("I am on the shortlisted property page")
    public void i_am_on_the_shortlisted_property_page() {
        tipsAndGrowthPage = new TipsAndGrowthPage(driver, extTest);
