...
public class TipsAndGuidesPage {
    ...
    public boolean clickBuyOption() {
        try {
            WebElement buyoption = wait.until(ExpectedConditions.elementToBeClickable(buyOption));
            buyoption.click();
    ...
    public boolean selectTipsAndGrowthTab() {
        try {
            WebElement tipsAndgrowthTab = wait.until(ExpectedConditions.elementToBeClickable(tipsAndGrowthTab));
    ...
    public boolean enterLocationForTipsAndGrowth(String location) {
        try {
            WebElement explorelocationBox = wait.until(ExpectedConditions.elementToBeClickable(exploreLocationBox));
    ...
    public boolean validateTipsAndGrowthPage() {
        try {
            WebElement ratingElement = wait.until(ExpectedConditions.visibilityOfElementLocated(tipsAndGrowthPageRating));
